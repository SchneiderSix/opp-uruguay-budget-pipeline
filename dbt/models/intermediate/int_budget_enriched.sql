...
enriched as (
    select
        *,
        ...
        case
            when prev_year_inversion is not null and prev_year_inversion > 0
            then round((inversion - prev_year_inversion) / prev_year_inversion * 100, 2)
            else 0
        end as inversion_yoy_pct_change,
        case
